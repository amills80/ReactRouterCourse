  ...
  render() {
    return (
      <div className="main-content home">
        ...
        <p>This fun directory is a project for the <em>React Router Basics</em> course on Treehouse. This app was built by Alan Mills in 2018.</p>
        {/*
     ...
     <Link to="teachers/HTML/Tommy&nbsp;Wingo">Tommy Wingo</Link>
        <Link to="teachers/Guitar&nbsp;Lessons/Dave&nbsp;Dennison">Dave Dennison</Link>
        <Link to="teachers/React/Abe&nbsp;Jackson">Abe Jackson</Link>
        <hr />
